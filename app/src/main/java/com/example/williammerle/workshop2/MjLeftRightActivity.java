...
public class MjLeftRightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mj_left_right);
        final TextView time = (TextView) findViewById(R.id.time);
        new AlertDialog.Builder(MjLeftRightActivity.this)
                .setTitle("Jeu gauche / droite")
                .setMessage("Le but du jeu est de faire bouger la boule de gauche à droite "+ AR_NUMBER +" fois ! Vous avez 1 minute")
